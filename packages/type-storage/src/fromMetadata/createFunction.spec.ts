...
import { stringToU8a, u8aConcat, u8aToString, u8aToHex } from '@polkadot/util';
...
describe('createFunction', () => {
  ...
  describe('the created double map function', () => {
    ...
    it('should return correct key', () => {
      ...
      expect(u8aToHex(result)).toEqual('0x00fa40e72d7173e69ee54b980345ea01cb81e64258502e0247af4303dee91ec0aec2ecd3a60ab080cff7b52a8f6d543b');
    });

    it('need two arguments', () => {
      expect(
